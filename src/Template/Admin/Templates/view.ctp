<?= $this->element('header',['title' => 'View','menus' => [ '<i class="fa fa-list"></i><p>List </p>' => ['action' => 'index'], '<i class="fa fa-plus"></i><p>Add</p>' => ['action' => 'add'], '<i class="fa fa-edit"></i><p>Edit</p>' => ['action' => 'edit', $template->id]]]) ?>
  ...
  <div class="container-fluid">
    <div class="row">
          ...
          <div class="content">
            ...
            <table class="table">
              ...
              <tbody>
                  ...
                  <td><?= h($template->name) ?></td>
                                                                ...
                                                                <tr>
                  <th scope="row"><?= __('Layout Path') ?></th>
                  <td><?= h($template->layout_path) ?></td>
                </tr>
                                                                                                                <tr>
            ...
            <div class="text-center" style="margin-top: 20px;">
              <div class="btn-group">
                ...
                <?= $this->Html->link(__('Edit Template'), ['action' => 'edit', $template->id], ['class'=>'btn btn-info btn-sm btn-fill']) ?>
                <?= $this->Form->postLink(__('Delete Template'), ['action' => 'delete', $template->id], ['class'=>'btn btn-danger btn-sm btn-fill', 'confirm' => __('Are you sure you want to delete # {0}?', $template->id)]) ?>
              </div>
            </div>
          </div>
        </div><!-- end card view -->
      ...
      <div class="col-md-12">
        ...
        <?php if (!empty($template->newsletters)): ?>
          <div class="card">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <table id="datatables" class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                        ...
                        <tbody>
                          <?php foreach ($template->newsletters as $newsletters): ?>
                            <tr>
